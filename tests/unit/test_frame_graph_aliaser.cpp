...
TEST(FrameGraphAliaser, ComplexGraphAliasing) {
    ...
    [[maybe_unused]] u32 albedo   = aliaser.DeclareResource(AliasResourceType::RenderTarget, 8000, 0, 1, "Albedo");
    [[maybe_unused]] u32 normal   = aliaser.DeclareResource(AliasResourceType::RenderTarget, 8000, 0, 1, "Normal");
    [[maybe_unused]] u32 lighting = aliaser.DeclareResource(AliasResourceType::RenderTarget, 8000, 1, 2, "Lighting");
    [[maybe_unused]] u32 postTemp = aliaser.DeclareResource(AliasResourceType::RenderTarget, 8000, 2, 3, "PostTemp");
    [[maybe_unused]] u32 finalRT  = aliaser.DeclareResource(AliasResourceType::RenderTarget, 8000, 3, 3, "Final");
...
TEST(FrameGraphAliaser, MinResourceSizeFilter) {
    ...
    [[maybe_unused]] u32 a = aliaser.DeclareResource(AliasResourceType::RenderTarget, 100, 0, 1);
    [[maybe_unused]] u32 b = aliaser.DeclareResource(AliasResourceType::RenderTarget, 100, 2, 3);
