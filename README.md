...
├── shaders/            # 111 HLSL compute/vertex/fragment shaders
...
│   ├── postprocess/    # Bloom, tonemap, TSR, DOF bokeh, motion blur, TAA, FXAA, SVGF denoise, auto-exposure, CAS, chromatic aberration, ocean, DOF, color grading, halftone/dither, watercolor, glitch, ink painting, ASCII art, outline edge, speed lines, night vision, pixelation, chromatic vignette, CRT scanline, neon glow, thermal vision, energy shield, weather particles
