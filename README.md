...
├── shaders/            # 64 HLSL compute/vertex/fragment shaders
...
├── tests/              # 38 test files (unit + integration)
├── CMakeLists.txt
├── CMakePresets.json
├── vcpkg.json
