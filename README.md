...
├── shaders/            # 57 HLSL compute/vertex/fragment shaders
...
├── tests/              # 31 test files (unit + integration)
├── CMakeLists.txt
├── CMakePresets.json
├── vcpkg.json
