...
namespace spirv {
    ...
    [[maybe_unused]] constexpr u32 OpMemberDecorate   = 72;
    constexpr u32 OpName             = 5;
    [[maybe_unused]] constexpr u32 OpMemberName       = 6;
    [[maybe_unused]] constexpr u32 OpTypeVoid         = 19;
    [[maybe_unused]] constexpr u32 OpTypeBool         = 20;
    constexpr u32 OpTypeInt          = 21;
    constexpr u32 OpTypeFloat        = 22;
    constexpr u32 OpTypeVector       = 23;
    [[maybe_unused]] constexpr u32 OpTypeMatrix       = 24;
